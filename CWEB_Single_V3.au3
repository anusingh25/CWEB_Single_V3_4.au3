...
Func Example()
	Local $lGUI = GUICreate("My GUI radio", 170, 130, 1995, 910) ; will create a dialog box that when displayed is centered
	...
	Local $idRadio4 = GUICtrlCreateRadio("Development Projects", 10, 100, 120, 20)
	...
	While 1
		...
		Select
			...
			Case $idMsg = $idRadio4 And BitAND(GUICtrlRead($idRadio4), $GUI_CHECKED) = $GUI_CHECKED
				Global $proj = "Development Projects"
				;MsgBox($MB_SYSTEMMODAL, 'Info:', 'You clicked on Radio 2 and it is Checked.')
				GUISetState(@SW_HIDE, $lGUI)
				ExitLoop
