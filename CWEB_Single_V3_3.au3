...
;V3_3 Added feature to highlight part and open drawing Ctrl+alt+PGDN
...
;get drawing of highlighted part
Func query()
...
Local $hWnd = WinActivate("NX I-deas 6.2 :    Nissan Forklift -Install #30846-Hotline 1-800-955-0000 : users.singha : C:\Temp\NXI6\10Aug2016.mf1 - [I-deas Graphics]")
	...
	Global $ret=MsgBox($MB_YESNO, "SRE Example 4 Result", $aResult[$n-1])
	EndIf
	if $ret=6 then
